...
<body style="margin: 0; width: 100%; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
  <div role="article" aria-roledescription="email" aria-label lang="en">
                          ...
                          <td>
                            <table style="width: 100%; border-radius: 12px; background-color: #fff; padding-left: 32px; padding-right: 32px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" cellpadding="0" cellspacing="0" role="presentation">
                              ...
                              <tr>
                                ...
                                <p class="sm-text-sm" style="margin: 0 0 24px; color: #334155">
                                    Kindly visit the HRMS portal for more details <a href ="{{ $login_Link}}/Performance/Self-Appraisal">HRMS LINK to be Provided</a>
                                </p>
                                  </p>
    ...
    @elseif ($approvalStatus == 'withdraw')
                            ...
                            <table style="width: 100%; border-radius: 12px; background-color: #fff; padding-left: 32px; padding-right: 32px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" cellpadding="0" cellspacing="0" role="presentation">
                              ...
                              <tr>
                                <td>
                                  ...
                                  <p class="sm-text-sm" style="margin: 0 0 24px; color: #334155">
                                    {{-- This is to inform you that {{ $emp_neutralgender }}{{ $user_emp_name }} has been rejected his/ her OKR/ PMS forms due to. " {{ $comments_employee }} ". --}}
                                    This is to inform you that your reporting {{ $emp_neutralgender }}{{ $user_emp_name }} has withdrawn his/her “OKR/ PMS for {{ $appraisal_period }}
                              </p>
                                  <p class="sm-text-sm" style="margin: 0 0 24px; color: #334155">
                                    If you have any questions or concerns, don’t hesitate to reach out to HR team.
                              </p>
                                  </p>
                                  <p>
                                    <a class=""
                      ...
                      <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                          <td>
                            ...
                            <p>
                                  <p class="sm-text-sm" style="margin: 0 0 24px; color: #334155">
                                    Greetings from the HR Team,<br>
                                    This is to inform you that your team member {{$emp_neutralgender}}
                                            {{ $user_emp_name }}
                                            has successfully submitted his/her “Self-Review for
                                        {{ $appraisal_period }}
                                    </p>
                            </p>
                            <p>
                                    ...
                                    <p class="sm-text-sm" style="margin: 0 0 24px;  color: #334155;">
                                        Also, kindly have a “Great Conversation” with “{{$emp_neutralgender}}{{ $user_emp_name }}” and Complete the OKR/PMS within the time frame
                                    </p>
                                    <p class="sm-text-sm" style="margin: 0 0 24px; color: #334155">
                                        Kindly visit the HRMS portal for more details <a href ="{{ $login_Link}}/Performance/Self-Appraisal">HRMS LINK to be Provided</a>
                                    </p>
